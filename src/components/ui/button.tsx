...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        primary: "bg-diana text-primary-foreground hover:bg-primary/90",
        secondary:
          "border-2 border-black bg-background hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        tertiary:
          "bg-transparent text-primary underline underline-offset-4 hover:bg-secondary/80",
        destructive:
      ...
      size: {
        lg: "h-14 px-14 has-[>svg]:px-6",
        default: "h-11 px-12 py-2 has-[>svg]:px-3",
        sm: "h-9 gap-1.5 px-6 has-[>svg]:px-2.5",
        icon: "size-9",
      },
    },
    defaultVariants: {
